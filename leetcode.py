...
def fetch_leetcode_data(username):
    try:
        ...
        st.error(f"LeetCode fetch error: {e}")
        return None
...
def fetch_codeforces_data(username):
    try:
        ...
        st.error(f"Codeforces fetch error: {e}")
        return None
...
user_input = st.text_input("Enter your profile URL or username (LeetCode / Codeforces / CodeChef / HackerRank / GitHub):")
